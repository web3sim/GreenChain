...
import { HEDERA_TESTNET_CONFIG, RPC_URL } from "../../config";
...
const onboard = Onboard({
  ...
  chains: [
    {
      id: HEDERA_TESTNET_CONFIG.chainId,
      token: HEDERA_TESTNET_CONFIG.nativeCurrency.symbol,
      namespace: "evm",
      label: HEDERA_TESTNET_CONFIG.chainName,
      rpcUrl: RPC_URL,
    },
  ],
  appMetadata: {
