...
import { wastemarketplaceAddress, EXPLORER_URL } from "../../config";
    ...
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      ...
      <ul className="text-white lg:text-3xl md:flex hidden  items-center flex-initial">
        ...
        <li className="text-black font-semibold bg-green-300 py-5 px-20 mx-14 rounded-full cursor-pointer hover:bg-green-800 hover:text-white">
          <a href={`${EXPLORER_URL}/contract/${wastemarketplaceAddress}`} target="_blank" rel="noreferrer">
            Contract Address
          </a>
        </li>
      </ul>
      <div className="flex relative">
        ...
        {toggleMenu && (
          ...
          >
            ...
            {["Home", "Create Waste", "Marketplace", "Dashboard", "About"].map(
